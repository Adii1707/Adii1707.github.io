      ...
      <div className="max-w-screen-lg pb-10 p-4 mx-auto flex flex-col justify-center w-full h-full">
        ...
        <div className="gap-x-2 w-full grid justify-center items-center text-center grid-cols-1 lg:grid-cols-2  grid-rows-1 gap-5 shadow-md ">
          {projects.map(({ id, src, link, github, name, stack, desc }) => (
            <div
              key={id}
              className=" border-red-500  h-[700px]  rounded-lg  p-3"
            >
              <img
                src={src}
                alt=""
              ...
              />
              <div>
                <h3 className="font-bold text-yellow-300 text-2xl pl-6 p-2 hover:scale-105">
                  {name}
                </h3>
                <p className=" text-black-800 p-2">{desc}</p>
                <h4 className="font-bold text-cyan-400 text-lg hover:scale-105 duration-200 pl-3 p-2">
                  Tech Stack: {stack}
                </h4>
              </div>
              <div className="flex items-center justify-center">
                <div className="flex items-center justify-center">
                  <button
                    ...
                    className="bg-pink-400 rounded-xl w-1/2 px-6 py-3 m-4 duration-200 hover:scale-105 "
                  >
                    Demo
                  </button>
                  <button
                    ...
                    className="bg-cyan-600 rounded-xl w-1/2 px-6 py-3 m-4 duration-200 hover:scale-105"
                  >
                    Code
                  </button>
                </div>
